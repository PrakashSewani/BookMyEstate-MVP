...
export default async function SavedPage() {
  ...
  const properties = Array.from(
    new Map(saved.map((s) => [s.property.id, s.property])).values()
  );
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 lg:px-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-brand-400 text-sm mt-1">{properties.length} properties saved</p>
            </div>
          ...
          {properties.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-brand-400">No saved properties yet.</p>
